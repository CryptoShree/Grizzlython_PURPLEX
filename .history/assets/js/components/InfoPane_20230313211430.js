    ...
    return (
        <div className="info-pane">
            <div className={classNames("pane-nav", {
                ...
                <svg version="1.0" xmlns="http://www.w3.org/2000/svg"  width="300pt" height="200pt" viewBox="0 0 900.000000 6.000000"> 
                    
<g transform="translate(250.000000,250.000000) scale(0.10000,-0.10000)" fill="#FFFFFF" stroke="none"> 
